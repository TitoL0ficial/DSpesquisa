create table tb_game (platform smallint check (platform between 0 and 2), genre_id bigint, id bigint generated by default as identity, title varchar(255), primary key (id));
create table tb_genre (id bigint generated by default as identity, name varchar(255), primary key (id));
create table tb_record (age integer, game_id bigint, id bigint generated by default as identity, moment timestamp(6) with time zone, name varchar(255), primary key (id));
